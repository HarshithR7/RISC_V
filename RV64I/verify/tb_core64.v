`timescale 1ns / 1ps
// Generic self-checking testbench core for the RV64I processor. Same
// convention as the RV32I suite's tb_core.v: program ends with
//   li x31, 0xFFFF0000 ; ecall     on success
//   li x31, <check_id>  ; ecall    on the first failed check
module tb_core64 #(
